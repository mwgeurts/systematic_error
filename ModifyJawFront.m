function plan = ModifyJawFront(plan, distance)
% ModifyJawFront is a delivery plan modification plugin for the
% TomoTherapy FMEA simulation tool.  This plugin adjusts the front jaw 
...
%   distance: a number (or string) indicating the deviation in front jaw 
%       positions, in mm.
%
...
% Log event
Event(sprintf('Adjusting front jaws by %0.2f mm', distance));
